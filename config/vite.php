...
return [
    ...
    */
    "aliases" => [
        ...
        "@A" => "resources/assets",
        "@I" => "resources/assets/img",
        "@F" => "resources/assets/fonts",
    ],
    ...
    */
    "interfaces" => [
        "heartbeat_checker" =>
            Innocenzi\Vite\HeartbeatCheckers\HttpHeartbeatChecker::class,
        "tag_generator" =>
            Innocenzi\Vite\TagGenerators\CallbackTagGenerator::class,
        "entrypoints_finder" =>
            Innocenzi\Vite\EntrypointsFinder\DefaultEntrypointsFinder::class,
    ],
